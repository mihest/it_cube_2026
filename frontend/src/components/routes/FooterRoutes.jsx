...
export default function FooterRoutes() {
    return (
        <footer className="border-t border-white/10 bg-[#040404]">
            <div className="mx-auto grid max-w-[1600px] gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:px-10 xl:px-16">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-[22px] border border-white/10 bg-white/5 p-4">
                        <div className="mb-2 text-sm font-semibold text-white">Что внутри</div>
                        <div className="space-y-2 text-sm text-white/55">
                            <div>Подбор маршрутов по фильтрам</div>
                            <div>Карта и отзывы</div>
                            <div>Рейтинг и даты</div>
                            <div>Быстрое бронирование</div>
                        </div>
                    </div>

                    <div className="rounded-[22px] border border-white/10 bg-white/5 p-4">
                        <div className="mb-2 text-sm font-semibold text-white">Акцент проекта</div>
                        <div className="space-y-2 text-sm text-white/55">
                            <div>Волонтёрские туры</div>
                            <div>Помощь природе</div>
                            <div>Поддержка локальных инициатив</div>
                            <div>T2-style интерфейс</div>
                        </div>
                    </div>
                </div>
            </div>
